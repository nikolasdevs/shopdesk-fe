...
const HowItWorks = () => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row w-full min-h-screen py-12 px-6 md:px-8 gap-20">
        ...
        <div className="lg:w-1/2 flex items-center justify-center mb-12 lg:mb-0 lg:pl-8 order-2 lg:order-1">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex items-center mb-2">
                 ...
                 {/* Number Circle */}
                 <div className={`w-16 h-16 md:w-20 md:h-20 rounded-full border-4 flex items-center justify-center transition-colors duration-300 ${
                  activeStep === index 
