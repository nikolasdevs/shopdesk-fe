...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      <div className="fixed inset-0 md:relative w-full md:max-w-[356px] bg-white transition-transform duration-300 ease-in-out transform translate-x-0 flex flex-col flex-grow items-center rounded-xl md:border md:border-[#DEE5ED] ml-4 mr-[5px] md:m-0">
        <div className="hidden md:flex py-5.5 px-4 items-center justify-between border-b border-b-[#DEE5ED] w-full">
          <p className="font-circular-medium text-2xl leading-9 capitalize">
            {selectedItem.name}
          </p>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col md:py-5 md:px-4 items-start gap-5 w-full p-3">
            ...
            <div className="flex p-3 items-center justify-between gap-5 rounded-md w-full border-b border-b-[#E9EEF3] md:border-none md:bg-[#F8FAFB]">
              <div className="flex flex-col gap-1 w-2/3">
                ...
                <p className="text-[#2A2A2A] text-[18px] md:text-[20px] leading-7.5 font-circular-normal capitalize">
                  {selectedItem.name}
                </p>
              </div>
              <p
